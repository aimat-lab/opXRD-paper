...
\newcommand{\partialexclam}[1]{\textcolor{orange}{\ding{52}(#1\%)}}
...
\label{tab:merged}
\scalebox{0.92}{
\begin{tabular}{@{}clccclll@{}}
\toprule
Institution & No. Patterns & Comp. & Spg & Lattice & Basis & Research Project \\ 
\midrule
CNRS        & \qquad 1052          & \cmark   & \cmark   & \cmark   &  \partialexclam{79}   & Extracted from the COD                 \\ 
