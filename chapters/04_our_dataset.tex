...
HKUST(GZ)   &  21+499          & \cmark   & \cmark   & \cmark   & \cmark[\quad]   & Phase/structure identification dataset  \\ 
USC         &  338          & \cmark   & \cmark   & \partialcheck{90}   & \xmark[\quad]   & Study of CuNi and CuAl alloys          \\ 
EMPA        &  790          & \cmark   & \partialcheck{63}   & \xmark   & \xmark[\quad]   & Tin halide perovskites, Zn-V-N libraries \\ 
INT         &  19,780        & \xmark   & \xmark   & \xmark   & \xmark[\quad]   & Compilation of various projects        \\ 
IKFT        &  64           & \xmark   & \xmark   & \xmark   & \xmark[\quad]   & Commercial catalysts, bulk materials   \\ 
LBNL        &  n/a          & \xmark   & \xmark   & \xmark   & \xmark[\quad]   & Perovskites precursors, Mn-Sb-O system  \\ 
\bottomrule
\end{tabular}
\end{adjustbox}}
\end{table}
