In collaboration with several other institutions we have collected a dataset of diffractograms stemming from experiments, some of them labeled with corresponding structural information. The following paragraphs detail the contribution of each research group. Most data was collected using \ce{Cu} radiaton sources which have a  $K_{\alpha1}$ wavelength of $\lambda=1.54056\text{\AA}$ and a $K_{\alpha2}$ wavelength of $\lambda=1.54439\text{\AA}$.
...
\midrule
CNRS        & \qquad 1052          & \cmark   & \partialcheck{85}   & \cmark   &  \partialcheck{85}   & Extracted from the COD \\ 
HKUST(GZ)   & \qquad 21           & \cmark   & \cmark   & \cmark   & \cmark   & Phase identification reference database \\ 
USC         & \qquad 338          & \cmark   & \cmark   & \partialcheck{90}   & \xmark   & Study of CuNi and CuAl alloys          \\ 
EMPA        & \qquad 790          & \cmark   & \partialcheck{63}   & \xmark   & \xmark   & Tin halide perovskites, Zn-V-N library \\ 
INT         & \qquad 19,780        & \xmark   & \xmark   & \xmark   & \xmark   & Compilation of various projects        \\ 
