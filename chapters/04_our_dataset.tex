...
\begin{table}[!htb]
\centering
\caption{Merged opXRD database entries}
\label{tab:merged}
\begin{tabular}{@{}cccc@{}}
\toprule
Institution & Research Project & No. Patterns & Available labels \\ 
\midrule
CNRS        & Extracted from the COD         & 895          & Spg, Lattice, Unit cell, Comp   \\ 
HKUST(GZ)   & Phase identification reference database              & 21           & Spg, Lattice, Unit cell, Comp   \\ 
USC         & Study of CuNi and CuAl alloys                            & 338          & Spg, Lattice, Comp   \\ 
EMPA        & Tin halide perovskites, Zn-V-N library  & 790          & Spg, Comp   \\ 
INT         & Compilation of various projects                 & 19780        & None \\ 
IKFT        & Commercial catalysts, bulk materials                 & 64           & None \\ 
LBNL        & Time series recordings of Perovskites            & n/a          & None \\ 
\bottomrule
\end{tabular}
\end{table}
