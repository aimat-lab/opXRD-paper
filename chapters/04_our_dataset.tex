...
\toprule
Institution & No. Patterns & Spg & Lattice & Unit Cell & Comp. & Research Project \\ 
\midrule
CNRS        & \qquad 895          & $\times$   & $\times$   & $\times$   & $\times$   & Extracted from the COD                 \\ 
HKUST(GZ)   & \qquad 21           & $\times$   & $\times$   & $\times$   & $\times$   & Phase identification reference database \\ 
USC         & \qquad 338          & $\times$   & $\times$   &            & $\times$   & Study of CuNi and CuAl alloys          \\ 
EMPA        & \qquad 790          & $\times$   &            &            & $\times$   & Tin halide perovskites, Zn-V-N library \\ 
INT         & \qquad 19780        &            &            &            &            & Compilation of various projects        \\ 
IKFT        & \qquad 64           &            &            &            &            & Commercial catalysts, bulk materials   \\ 
LBNL        & \qquad n/a          &            &            &            &            & Time series recordings of Perovskites  \\ 
\bottomrule
\end{tabular}
\end{table}
