...
\keywords{powder x-ray diffraction, machine learning, open-access data, crystal structure determination, phase identification}
...
\replaced{The opXRD database is available on Zenodo at \url{https://zenodo.org/records/15298026}.}{The opXRD database is available on Zenodo at \url{https://zenodo.org/records/14254270}.}\added{The database version this manuscript refers to is v11 on Zenodo.} \replaced{opXRD}{It} is published under the Creative Commons Attribution 4.0 International license. It can be downloaded by any user without any barriers or restrictions. For further details, please refer to Section~$\eqref{sec:how_to_use}$.
...
\bibliographystyle{bibstyle/MSP}
