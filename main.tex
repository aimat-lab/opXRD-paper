...
\title{Open Experimental Powder X-ray Diffraction Database}
...
\section{State-of-the-art ML for pXRD}\label{sec:sota_ML}
\input{paper/03_SOTA_ML}

\section{Our dataset}\label{sec:our_dataset}
\input{paper/04_our_dataset}

\section{How to use}\label{sec:how_to_use}
\input{paper/05_how_to_use}
